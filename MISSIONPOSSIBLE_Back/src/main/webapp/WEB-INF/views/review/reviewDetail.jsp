...
<div id="box">
 ...
 <!--   <th class="success">글번호</th>
       ...
       <table width="800" class="table01">			
              <tr>
                     <td width="95" height="30" bgcolor="#eeeeee" align="center">댓글 내용</td>
                     <td width="380" style="padding-left: 10px;">
                            <textarea rows="2" cols="55" class="boxTA" style="width: 500px; height: 50px" id="commentContent"></textarea>
                     </td>
...
<span id="listData" style="display: none;"></span>
				...
				<div class="btn_right mt15">
					...
					<button type="button" class="btn black mr5" onclick="location.href='${path}/review/reviewModify'">수정하기</button>
...
<script type="text/javascript">
	$("#btn-report").on("click", (e)=>{
		// 신고하기 창 띄우기
		const url = "${path}/review/reviewReport";
